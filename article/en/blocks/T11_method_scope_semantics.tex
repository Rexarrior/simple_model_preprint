...
used only for runs with status \texttt{OPTIMAL}. A feasible schedule of length
$B_4$ proves that the bound is attainable, but equality between the lower bound
and the best solution found is insufficient unless the solver gap has been
closed.
