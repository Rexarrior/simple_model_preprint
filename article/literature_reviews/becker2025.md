...
**Проверенная версия:** на первой странице указано `arXiv:2507.09089v2 [cs.AI] 25 Jul 2025` (PDF с. 1). Metadata arXiv также указывает v2 как текущую версию, 51 страницу, 8 таблиц и 22 рисунка. Локальная копия: `becker2025.pdf`, SHA-256 `3e18d9e097a3163dbae662e8b7c68ace0510be433891994b136ae7730beab25c`.
