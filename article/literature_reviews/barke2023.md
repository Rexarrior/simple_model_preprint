...
**Проверенная версия:** издательская PDF-версия с датой публикации April 2023, `Proc. ACM Program. Lang. 7, OOPSLA1, Article 78`. Отдельный номер ревизии в документе отсутствует. Локальная копия: `/Users/rexarrior/work/articles/simple_model_full/literature/barke2023.pdf`, SHA-256 `d73402c4a8890dc076be999d108e69f9b1967d6663c95f79c64343c293e161db`.
